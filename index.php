...
<body>
        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#skills"><i class="bx bx-table"></i> <span> Skills </span></a></li>
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span> Resume </span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i> Vlogs </a></li>
                    <li><a href="#contact"><i class="bx bx-envelope"></i> Contact </a></li>
                    <li><a href="services.php"><i class="bx bx-car"></i> Services </a></li>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
          ...
          <center><a href="#portfolio" class=""><button type="button" class="btn btn-primary btn-sm"> Watch My YouTube Videos </button></a>
          <a href="#portfolio"><button type="button" class="btn btn-primary btn-sm"> View My Services </button></a>
        </center>
        </div>
    </section><!-- End Hero -->
...
while($data5=mysqli_fetch_array($runquery5)){
    ?>
                <iframe width="250" height="250" src="https://www.youtube-nocookie.com/embed/<?=$data5['projectlink']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    <?php
}
                    ?>
...
-->
            <div class="credits">
                Maintained by <a href="#"> Chris-Jnr </a> &copy 2023
            </div>
        </div>
    </footer><!-- End  Footer -->
