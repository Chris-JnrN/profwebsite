...
?> 
  ...
  <option value="pe">Pofessional Experience</option>
    ...
    <input type="text" name="title" class="form-control" id="website" placeholder=" Input Data " required>
  </div>
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" class="form-control" id="website" placeholder=" Input Data " required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
    <input type="text" name="year" class="form-control" id="website" placeholder=" Input Year " required>
  </div>
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (leave blank if you dont want to)</label>
    <textarea class="form-control" name="workdesc" id="exampleFormControlTextarea1" rows="3" placeholder=" Input Data "></textarea>
  </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <option value="pe" selected>Pofessional Experience</option>
                    <?php    }
                     ...
                     <div class="form-group col-md-8">
    <label for="sn">Course/Position Name</label>
    <input type="text" name="title" value="<?=$data2['title']?>" class="form-control" id="website" placeholder=" Input Data " required>
  </div>
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" value="<?=$data2['ogname']?>" class="form-control" id="website" placeholder=" Input Data " required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
    <input type="text" name="year" value="<?=$data2['year']?>" class="form-control" id="website" placeholder=" Input Year " required>
  </div>
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (leave blank if you dont want to)</label>
    <textarea class="form-control" name="workdesc" id="exampleFormControlTextarea1" rows="3" placeholder=" Input Data "><?=$data2['workdesc']?></textarea>
  </div>
