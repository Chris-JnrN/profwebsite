 <h2>Edit YouTube Videos Section</h2>
         <?php
         if(isset($_GET['msg'])){
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" name="projectlink" class="form-control" id="email" placeholder="cQpHIgiSlXY">
    </div>
    <div class="form-group col-md-2 ml-auto">
        <input type="submit" name="addtoportfolio" class="btn btn-primary" value=" Upload Video ">
    </div>
    ...
    <div class="form-group col-md-12">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" name="pupdate" value="Update">
         ...
         <td>
             <a href="https://www.youtube.com/watch?v=<?=$data2['projectlink']?>"> <button type="button" class="btn btn-success btn-sm">Visit</button></a>
